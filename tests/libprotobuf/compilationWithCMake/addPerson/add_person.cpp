...
{
cout << "Uknown phone type. Using default." << endl;
}
...
{
//Verify that the version of the library that we link against is compatitible with the version of the headers we compiled against
